...
**Stellar-AgentKit** ⛓️ — AI agent toolkit on the Stellar blockchain, because web3 needed more agents apparently

**StellarPay** 💸 — On-chain payroll platform, for when you want your salary to be someone else's gas fee problem

**CalliopeIDE** 🖥️ — A browser-based code editor, because VS Code wasn't already everywhere enough
